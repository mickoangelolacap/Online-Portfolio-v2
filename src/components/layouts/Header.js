  ...
  return (
    <Navbar id="header" variant={theme} expand="lg">
      <Container fluid className="p-0">
        <Navbar.Brand href="#header" id="navbarBrand">
          MA<span className="text-primary">C</span>L
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto">
            ...
            <Nav.Link className="navLinks" href="#works">
              Works
            </Nav.Link>
            <Nav.Link
              className="navLinks text-primary"
            ...
            <Nav.Link
              ...
              target="_blank"
              rel="noreferrer"
              href="https://drive.google.com/file/d/1YXtFuAAoOr_VZ2i-hUGLMR3PVtd45s81/view?usp=sharing"
            >
              Resume / CV
            </Nav.Link>
          </Nav>
